...
/// @brief Equivalent to csp_atomic_shared_ptr_store(_this, _desired, _e).
void csp_atomic_shared_ptr_s(csp_atomic_shared_ptr *_this, csp_shared_ptr _desired, csp_exception *_e);
...
[[nodiscard]] csp_shared_ptr csp_atomic_shared_ptr_load(const csp_atomic_shared_ptr *_this, csp_exception *_e);
...
[[nodiscard]] csp_shared_ptr csp_atomic_shared_ptr_load_explicit(const csp_atomic_shared_ptr *_this, memory_order _order, csp_exception *_e);
...
void csp_atomic_shared_ptr_store(csp_atomic_shared_ptr *_this, csp_shared_ptr _desired, csp_exception *_e);
...
void csp_atomic_shared_ptr_store_explicit(csp_atomic_shared_ptr *_this, csp_shared_ptr _desired, memory_order _order, csp_exception *_e);
...
[[nodiscard]] csp_shared_ptr csp_atomic_shared_ptr_exchange(csp_atomic_shared_ptr *_this, csp_shared_ptr _desired, csp_exception *_e);
...
[[nodiscard]] csp_shared_ptr csp_atomic_shared_ptr_exchange_explicit(csp_atomic_shared_ptr *_this, csp_shared_ptr _desired, memory_order _order, csp_exception *_e);

/// @brief Equivalent to: return csp_atomic_shared_ptr_compare_exchange_weak_explicit(_this, _expected, _desired, memory_order_seq_cst, memory_order_seq_cst, _e).
[[nodiscard]] bool csp_atomic_shared_ptr_compare_exchange_weak(csp_atomic_shared_ptr *_this, csp_shared_ptr *_expected, csp_shared_ptr _desired, csp_exception *_e);

/// @brief Same as csp_atomic_shared_ptr_compare_exchange_strong_explicit, but may also fail spuriously.
[[nodiscard]] bool csp_atomic_shared_ptr_compare_exchange_weak_explicit(csp_atomic_shared_ptr *_this, csp_shared_ptr *_expected, csp_shared_ptr _desired, memory_order _success, memory_order _failure, csp_exception *_e);

/// @brief Equivalent to: return csp_atomic_shared_ptr_compare_exchange_strong_explicit(_this, _expected, _desired, memory_order_seq_cst, memory_order_seq_cst, _e).
[[nodiscard]] bool csp_atomic_shared_ptr_compare_exchange_strong(csp_atomic_shared_ptr *_this, csp_shared_ptr *_expected, csp_shared_ptr _desired, csp_exception *_e);
...
[[nodiscard]] bool csp_atomic_shared_ptr_compare_exchange_strong_explicit(csp_atomic_shared_ptr *_this, csp_shared_ptr *_expected, csp_shared_ptr _desired, memory_order _success, memory_order _failure, csp_exception *_e);
