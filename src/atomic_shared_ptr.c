...
void csp_atomic_shared_ptr_s(csp_atomic_shared_ptr *const _this, const csp_shared_ptr _desired, csp_exception *const _e)
{
    assert(_this);
    assert(_e);

    csp_atomic_shared_ptr_store(_this, _desired, _e);
}
...
csp_shared_ptr csp_atomic_shared_ptr_load(const csp_atomic_shared_ptr *const _this, csp_exception *const _e)
{
    assert(_this);
    assert(_e);
...
csp_shared_ptr csp_atomic_shared_ptr_load_explicit(const csp_atomic_shared_ptr* const _this, [[maybe_unused]] const memory_order _order, csp_exception* const _e)
{
    ...
    return csp_atomic_shared_ptr_load(_this, _e);
}

void csp_atomic_shared_ptr_store(csp_atomic_shared_ptr *const _this, csp_shared_ptr _desired, csp_exception *const _e)
{
    assert(_this);
    assert(_e);
...
csp_shared_ptr csp_atomic_shared_ptr_exchange(csp_atomic_shared_ptr *const _this, csp_shared_ptr _desired, csp_exception *const _e)
{
    assert(_this);
    assert(_e);
...
csp_shared_ptr csp_atomic_shared_ptr_exchange_explicit(csp_atomic_shared_ptr* const _this, const csp_shared_ptr _desired, [[maybe_unused]] const memory_order _order, csp_exception* const _e)
{
    ...
    return csp_atomic_shared_ptr_exchange(_this, _desired, _e);
}

bool csp_atomic_shared_ptr_compare_exchange_weak(csp_atomic_shared_ptr *const _this, csp_shared_ptr *const _expected, const csp_shared_ptr _desired, csp_exception *const _e)
{
    assert(_this);
    assert(_e);
...
bool csp_atomic_shared_ptr_compare_exchange_weak_explicit(csp_atomic_shared_ptr *const _this, csp_shared_ptr *const _expected, const csp_shared_ptr _desired, [[maybe_unused]] const memory_order _success, [[maybe_unused]] const memory_order _failure, csp_exception *const _e)
{
    ...
    return csp_atomic_shared_ptr_compare_exchange_weak(_this, _expected, _desired, _e);
}

bool csp_atomic_shared_ptr_compare_exchange_strong(csp_atomic_shared_ptr *const _this, csp_shared_ptr *const _expected, const csp_shared_ptr _desired, csp_exception *const _e)
{
    assert(_this);
    assert(_e);
